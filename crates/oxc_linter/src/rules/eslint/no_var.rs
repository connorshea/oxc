...
fn test() {
    ...
    let pass = vec![
        "let moo = 'car';",
        "const JOE = 'schmoe';",
        "declare module 'testModule' { var x: string; }",
        "declare namespace MyNamespace { var y: number; }",
        "declare global { var __TEST_DECLARE_GLOBAL__: boolean | undefined; }",
    ];
    ...
    let fail = vec![
        ...
        "var foo = () => foo();",
        "var foo = (function () { foo(); })();",
        "var foo = bar(function () { foo(); });",
        "var bar = foo, foo = function () { foo(); };",
        "var bar = foo; var foo = function () { foo(); };",
        "var { foo = foo } = function () { foo(); };",
        "var { bar = foo, foo } = function () { foo(); };",
        "var bar = function () { foo(); }; var foo = function() {};",
    ];
